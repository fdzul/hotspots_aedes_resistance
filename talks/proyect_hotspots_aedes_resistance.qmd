...
<br>
<p style="color:#660033;">Las áreas identificadas como los hotspots de transmisión de las arbovirosis son áreas donde existe una alta presión de selección de resistencia en *Aedes aegypti*, la cual es reflejada en elevados niveles de resistencia (LC50), altas frecuencias de genes de resistencia (V1016I & F1534C) y elevados niveles enzimáticos (esterasas,  alfa y beta esterasas, glutation s-transferesas, pnpa esterasas, y Citocromo p450). </p>
